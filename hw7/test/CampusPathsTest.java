...
public class CampusPathsTest { // Rename to the name of your "main" class
	...
	@Test
	public void testUnknownIds() throws IOException {
		runTest("test3");
	}
	
	@Test
	public void testUnknownBuildingNames() throws IOException {
		runTest("test4");
	}
	
	@Test
	public void testPathToSelf() throws IOException {
		runTest("test5");
	}
	
	@Test
	public void testUnknownMixedIDNames() throws IOException {
		runTest("test6");
	}
